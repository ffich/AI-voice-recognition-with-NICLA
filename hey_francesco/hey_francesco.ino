...
/* Includes ---------------------------------------------------------------- */
#include <FFich-Hey-Francesco_inferencing.h>
#include <PDM.h>
...
void loop()
{
    ...
    // If the condfidence is higher than our threshold, blink LED and print screen
    if (result.classification[0].value > CONFIDENCE_LEVEL)
    {
       ei_printf("Hey Francesco!!!\r\n");
